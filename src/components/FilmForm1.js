    ...
    return(
        <div id="first_div" className="bg-neutral-900 px-10 md:px-44 pt-20">
            <div id="cover_div" className="flex justify-start items-end w-full h-48 lg:h-72 xl:h-96 bg-blue-200 rounded-xl bg-cover bg-center bg-no-repeat select-none">
                <div className="flex flex-col justify-center items-center w-48 lg:w-64 xl:w-72 h-24 lg:h-28 xl:h-36 bg-blue-900/90 backdrop-blur-sm rounded-tr-xl rounded-bl-xl">
                    <h1 className="text-white font-bold text-xl lg:text-2xl xl:text-3xl">Во все тяжкие</h1>
                    <button onClick={scrollTop} className="flex bg-blue-500 w-24 lg:w-28 xl:w-32 h-8 md:h-10 mt-3 lg:mt-4 xl:mt-5 text-white rounded-lg md:rounded-xl
