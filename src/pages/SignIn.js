    ...
    return (
        <div className="scroll-smooth bg-neutral-900">
            ...
            <div className="flex flex-col items-center w-full h-screen">
                ...
                <p className="mt-32 md:mt-48 text-white text-md">Нет аккаунта? <a href="/registration"><span className="text-white hover:text-blue-500 font-bold text-md ease-in-out duration-300">Зарегистрироваться</span></a></p>
            </div>
        </div>
    );
}
